...
class AppGUI(rumps.App):
    def __init__(self):
        ...
        # Install global and local hotkey monitors
        try:
            self._install_global_hotkey()
        except Exception:
            logging.exception("Failed to install global hotkey monitor")
    ...
    def _install_global_hotkey(self):
        ...
        # Also add a local monitor for when our app is key
        try:
            self._hotkey_local = NSEvent.addLocalMonitorForEventsMatchingMask_handler_(NSEventMaskKeyDown, _handle_global)
        except Exception:
            self._hotkey_local = None
